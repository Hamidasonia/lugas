          ...
          <div class="navbar-brand w-100"
            ...
            <a href="#" style="text-decoration: none; color: inherit; display: flex; align-items: center;">
              <div class="row" style="display: flex ; flex-direction: column; align-items: center; gap: 10px;">
                <img src="{{ asset('img/photos/logo-lugas.png') }}" alt=""
      ...
      <div class="offcanvas offcanvas-end text-inverse" id="offcanvas-info" data-bs-scroll="true">
        ...
        <div class="offcanvas-body pb-6">
          <div class="widget mb-8">
            <p>LUGAS adalah konsultan pembangunan dan manajemen kandang ayam petelur Indonesia yang mengedepankan
              efisiensi dalam produksi </p>
          </div>
          <!-- /.widget -->
          <div class="widget mb-8">
  ...
  <footer class="bg-dark text-inverse">
    <div class="container py-13 py-md-15">
      <div class="row gy-6 gy-lg-0">
        <div class="col-lg-4">
          <div class="widget">
            <img class="mb-4" src="{{ asset('img/favicon-lugas.png') }}" alt="" />
            <p class="mb-4">© <script>
